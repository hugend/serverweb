...
<body>
	<h1>부서정보출력하기 - json을 텍스트형태로 전달받은경우</h1>
	...
	<script type="text/javascript">
		var deptlist = '{"dept":'
			...
			+']'
			+'}'
			//텍스트의 형태로  json을 전달되는 경우 자바스크립트에서 사용하려면 텍스트를 json객체로 
			//변환하는 작업을 해야한다. - 파싱
			//eval 함수를 이용해서 json 객체를 실행
		...
		alert(mydata2);	
		document.getElementById("dept_parser").innerHTML= mydata2;
